...
_STYLE_EFFECTS: dict[EditStyle, EffectConfig] = {
    EditStyle.AGGRESSIVE: EffectConfig(
        ...
        time_remap=True,
        vignette=True, vignette_intensity=1.2,
        grain=True, grain_intensity=0.4, grain_style="film",
    ),
    EditStyle.SMOOTH: EffectConfig(
        ...
        grain=True, grain_intensity=0.3, grain_style="film",
    ),
    EditStyle.DARK: EffectConfig(
        ...
        time_remap=True,
        vignette=True, vignette_intensity=1.5,
        grain=True, grain_intensity=0.6, grain_style="heavy",
    ),
    EditStyle.LOFI: EffectConfig(
        color_grade=True, color_style="warm",
        vignette=True, vignette_intensity=0.8,
        grain=True, grain_intensity=0.7, grain_style="vhs",
    ),
}
